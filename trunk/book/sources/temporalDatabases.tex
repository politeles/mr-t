...
\subsection{\label{subsubsec:consistency}Consistency in Temporal Relations}
...
Consider again the example relation visualized in table \ref{table:example-database}. Imagine John left the company, but nobody updated the relation, so it is not known when 
