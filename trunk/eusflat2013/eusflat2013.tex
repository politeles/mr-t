...
\begin{abstract}
Information systems model parts of reality by representing properties of real-world objects or concepts. As real-world objects or concepts often have temporal aspects, temporal notions such as time intervals are often represented too. However, such temporal notions may contain imperfections like uncertainties, complicating their representations. One of the most important purposes of information systems is to be able to query them to retrieve information. The presence of representations of temporal notions containing uncertainties severely complicates querying. Thus, several soft computing techniques have been proposed to represent time intervals subject to uncertainties in a semantically sound way and to reason with them in a semantically sound and usefull way, without losing (much) information. In the presented work, two frameworks designed for this are compared. It is found that, despite differences in the way these frameworks represent intervals, they provide the same results when reasoning about time intervals subject to uncertainty.
\end{abstract}
...
\input{notations_and_nomenclature}
