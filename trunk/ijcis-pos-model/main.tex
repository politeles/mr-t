...
\shortauthors{C. Billiet, N. Mar\'{i}n, J. Pons,  O. Pons,  G. De Tr\'{e}}
% Short title
\shorttitle{A Possibilistic Valid-time Model for Relational Databases}
%---------------------------------------------------------------------------
%
%---------------------- YOUR TITLE ----------------------------------------
\title{A Possibilistic Valid-time Model for Relational Databases} 
% \\ \vspace*{0.04truein}
...
%-------------------------- AUTHOR'S NAMES ----------------------------------
\author{%
Christophe Billiet\,\up{2}, Nicol\'{a}s Mar\'{i}n\,\up{1}, Jose Enrique Pons*\,\up{1},  Olga Pons\,\up{1}, Guy de Tr\'{e}\,\up{2}
}
%----------------------------- ADDRESSES ----------------------------------
\addresses{%
%\address{
